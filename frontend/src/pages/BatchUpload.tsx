...
export const BatchUpload: React.FC = () => {
  ...
  return (
    <div className="max-w-2xl mx-auto bg-white rounded-xl shadow-sm border border-gray-100 p-8 text-center mt-10">
      ...
      <p className="text-gray-500 mb-8">Upload a CSV file containing patient data to run multiple predictions simultaneously. The system will return a downloadable CSV appended with predictions and risk levels.</p>
      ...
      {file && <p className="text-sm font-medium text-gray-700 mb-4">Selected File: {file.name}</p>}
